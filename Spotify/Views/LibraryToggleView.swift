...
//  Spotify
//
//  Created by Dmitrii Dorogov on 19.08.2023.
//
...
class LibraryToggleView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        playlistButton.addTarget(self, action: #selector(didTapPlalists), for: .touchUpInside)
    ...
    @objc private func didTapPlalists() {
        state = .playlist
